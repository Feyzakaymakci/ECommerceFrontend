...
{path:"", component:HomeComponent}, //Anasayfa çalışmalarında direkt componenti veriyoruz. Boş olan isteklerde.
...
{path:"update-password", loadChildren: () => import("./ui/components/password-reset/password-reset.module").then(module => module.PasswordResetModule) },
{path:"password-reset", loadChildren: () => import("./ui/components/update-password/update-password.module").then(module => module.UpdatePasswordModule) },
